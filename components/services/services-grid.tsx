...
const ServiceCard = ({ service, index, ctaLabel }: { service: Service; index: number; ctaLabel: string }) => {
...
export default function ServicesGrid({ heading, description, ctaLabel, services, ctaHeading, ctaDescription, ctaPrimaryLabel, ctaPrimaryHref }: ServicesGridProps) {
  return (
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="space-y-24 lg:space-y-32">
            {services.map((service, index) => (
              <ServiceCard key={service.id} service={service} index={index} ctaLabel={ctaLabel} />
            ))}
          </div>
