        ...
        <div className="grid grid-cols-1 gap-12 md:gap-16 lg:gap-20">
          ...
          >
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              SR Software and SR Web, we cover the full spectrum of digital transformation Enterprise Platforms,
              Artificial Intelligence & Automation,Mobile Applications,Web & Cloud Infrastructure,Technical Support & Maintenance
            </motion.p>
          </motion.div>
